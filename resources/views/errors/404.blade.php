      ...
      <div id="error">
        <div class="text-center">
          ...
          >
              ...
              <path
                  class="cls-10 faceMove"
                  d="M83.06,40.36a4,4,0,0,1,2.75-1"
              ></path>
              <line
              ...
              <path
                  class="cls-3"
                  d="M115.4,52.56a53.27,53.27,0,0,1,8,2l1,.42"
              ></path>
              <path
              ...
              <path
                  class="cls-12"
                  d="M88.15,60.27s1.7.95,1.7,2.22"
              ></path>
              <path
                  class="cls-5"
                  d="M101.81,61a6.68,6.68,0,0,0,8.51,0Z"
              ></path>
              <polygon
                  class="cls-5"
          ...
          <div class="flex flex-col justify-center md:-mt-32">
                ...
                <a href="/">
                    <svg class="inline-block mb-2 fill-current text-gray-800" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path class="heroicon-ui" d="M5.41 11H21a1 1 0 0 1 0 2H5.41l5.3 5.3a1 1 0 0 1-1.42 1.4l-7-7a1 1 0 0 1 0-1.4l7-7a1 1 0 0 1 1.42 1.4L5.4 11z"/></svg>
                    <span class="md:text-2xl text-sm text-gray-800">Back to Home</span>
                </a>
          </div>
        </div>
      </div>
